            ...
            <div className='container'>
                <div className='text-[#fff] absolute top-[50%]  -translate-y-[50%] '>
                    <div data-aos="fade-right">
                        ...
                        <button className='bg-green text-[#000]  border border-transparent transition-all btn2 rounded-[20px]   py-[8px] px-[26px] font-semibold'>{t("why-do-they-choose-us")}</button>
                    </div>
                </div>
            </div>
        </div>
