    ...
    return (
        <div data-aos="fade-up" data-aos-delay={100} className='service-card group cursor-pointer p-[50px]  rounded-[5px] w-full md:w-[calc((100%-20px)/2)] lg:w-[calc((100%-40px)/3)]'>
            <div className='pb-[25px]'>
                <img src={media[0]?.original_url ?? NoteBlack} alt="" />
            ...
            <button onClick={handleApply} className='bg-green  font-medium text-shadow rounded-[25px]  px-[30px] py-[10px] inline-block' >{t("to-apply")}</button>
        </div>
    )
}
