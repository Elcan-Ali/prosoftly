            ...
            <div className='w-full md:w-[400px] py-[30px]  text-[#fff] overflow-y-auto h-full absolute right-0 bg-[#181819]'>
                ...
                <div className='pt-[30px]'>
                    ...
                    <ul className='px-[63px] flex items-center text-[20px] gap-[26px] pb-[50px] pt-[24px] '>
                        <li onClick={() => handleLang('az')} className={`${i18n.language === "az" && "border-b-[3px] border-[#Afff2c]"} cursor-pointer `}>Az</li>
                        <li onClick={() => handleLang('en')} className={`${i18n.language === "en" && "border-b-[3px] border-[#Afff2c]"} cursor-pointer `}>En</li>
                        <li onClick={() => handleLang('ru')} className={`${i18n.language === "ru" && "border-b-[3px] border-[#Afff2c]"} cursor-pointer `}>Ru</li>
