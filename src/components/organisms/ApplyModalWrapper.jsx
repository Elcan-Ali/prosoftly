...
function ApplyModalWrapper() {
    ...
    return (
        <div onClick={handleClose} className={`overlay overflow-y-auto fixed ${applyModal ? "top-0 bottom-0 opacity-1" : "-top-[200%] opacity-0 bottom-auto"} right-0 left-0  transition-all  duration-[.5s]  py-[70px]`}>
